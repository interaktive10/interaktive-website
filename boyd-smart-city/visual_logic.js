...
['',Math.round(_initGlob.percentage),''].join('');
...
var main_block_empties, industry, sub_industries_annotation_ids, selected_industry, popup_text, annotation_name, object_name, sub_industries_objects, interior_scene, internal_text_content, header, home_button, back_button, help_button, percentage, main_blocks, selected_sub_industry, inception_level, sub_industries, block, internal_text, annotation_id, ev_solution_annotations, internal_view, i, j, k, m;
...
function startPreloader() {
  setHTMLElemStyle('filter', 'blur(72px)', ['QUERYSELECTOR', '#v3d-container > canvas'], false);
  registerSetTimeout(0.2, function() {
...
'<p>Learn More:</p>' + '\n' +
'<p><a href="https://www.boydcorp.com/industries/5g-implementation.html" target="_blank" style="color: #E0673C; font-weight: bold; transition: color 0.3s ease-in-out;" onmouseover="this.style.color=\'#9D3C19\';" onmouseout="this.style.color=\'#E0673C\';">5G Implementation</a></p>'), ('<p>Boyd improves data center safety with flame barriers and electrical isolation that isolate electrical spark and fire.</p>' + '\n' +
'<p>Learn More:</p>' + '\n' +
